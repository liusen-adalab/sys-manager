...
macro_rules! impl_codec_single {
    ($msg:path) => {
        ...
        crate::impl_codec_single!(@implement Codec, $msg);
    };

    (@implement $codec:path, $msg:path) => {
        const _: () = {
            ...
            impl Decoder for $codec {
                ...
                fn decode(
                    ...
                    let msg = serde_json::from_slice(&bytes).context("deserialize")?;
                    Ok(Some(msg))
                }
            }
